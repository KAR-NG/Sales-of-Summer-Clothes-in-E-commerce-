...
The number of tags in relation to the number of each product sold will be very interesting to include. This value can be extracted from the "tags" column that has a massive amount of texts describing relevant tags. This extraction *has been done* in section 5.5. Here, I will just add the extracted column into the current dataset. 
